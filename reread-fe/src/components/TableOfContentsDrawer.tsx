...
export const TableOfContentsDrawer: React.FC<TableOfContentsDrawerProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/60 backdrop-blur-sm transition-all duration-300">
      ...
      <div
        className="relative w-full max-w-[420px] bg-[var(--app-surface)] text-[var(--app-text)] rounded-t-[28px] border-t border-[var(--app-border)] p-6 z-10 max-h-[80vh] flex flex-col shadow-2xl animate-slide-up select-none"
